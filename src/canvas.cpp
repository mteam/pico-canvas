...
namespace picocanvas {
    ...
    template void Canvas::draw_bitmap(const Bitmap1Bit &, const picocanvas::Point &);
    ...
    template void Canvas::draw_bitmap(const Bitmap1Bit &, const picocanvas::Point &, const picocanvas::Rect &);
